...
dim(pm0)
head(pm0)
cnames <- readLines("./exp-data/case-study/air-pollution/RD_501_88101_1999-0.txt", 1)
print(cnames)
...
pm1 <- read.table("./exp-data/case-study/air-pollution/RD_501_88101_2012-0.txt", comment.char = "#", header = FALSE, sep = "|", na.strings = "", nrow = 1304290)
